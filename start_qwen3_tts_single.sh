...
systemd-run --user \
    ...
    QWEN_TTS_PROSODY_OPTIMIZER_ENABLED="$PROSODY_ENABLED" \
    QWEN_TTS_PROSODY_BASE_URL="$PROSODY_BASE_URL" \
    QWEN_TTS_PROSODY_MODEL="$PROSODY_MODEL" \
    QWEN_TTS_PROSODY_TIMEOUT_S="$PROSODY_TIMEOUT_S" \
    QWEN_TTS_PROSODY_MAX_TOKENS="$PROSODY_MAX_TOKENS" \
    QWEN_TTS_PROSODY_MAX_INPUT_CHARS="$PROSODY_MAX_INPUT_CHARS" \
